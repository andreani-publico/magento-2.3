...
namespace DrubuNet\Andreani\Block\Adminhtml\Rate;

class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    /**
     * @var \DrubuNet\Andreani\Model\RateFactory
     */
     ...
     * @param \DrubuNet\Andreani\Model\RateFactory $tarifaFactory
     * @param array $data
     */
    public function __construct(
        ...
        \DrubuNet\Andreani\Model\RateFactory $tarifaFactory,
        array $data = []
    ) {
