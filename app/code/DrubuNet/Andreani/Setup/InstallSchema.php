...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if($installer->tableExists("ids_andreani_provincia")){
            $installer->getConnection()->renameTable($installer->getTable('ids_andreani_provincia'), $installer->getTable('drubunet_andreani_provincia'));
        }
        else {
            if(!$installer->tableExists("drubunet_andreani_provincia")) {
        ...
        if($installer->tableExists("ids_andreani_zona")){
            $installer->getConnection()->renameTable($installer->getTable('ids_andreani_zona'), $installer->getTable('drubunet_andreani_zona'));
        }
        else {
            if(!$installer->tableExists("drubunet_andreani_zona")) {
        ...
        if($installer->tableExists("ids_andreani_tarifa")){
            $installer->getConnection()->renameTable($installer->getTable('ids_andreani_tarifa'), $installer->getTable('drubunet_andreani_tarifa'));
        }
        else {
            if(!$installer->tableExists("drubunet_andreani_tarifa")) {
        ...
        if($installer->tableExists("ids_andreani_codigo_postal")){
            $installer->getConnection()->renameTable($installer->getTable('ids_andreani_codigo_postal'), $installer->getTable('drubunet_andreani_codigo_postal'));
        }
        else {
            if(!$installer->tableExists("drubunet_andreani_codigo_postal")) {
        ...
        if($installer->tableExists("ids_andreani_sucursal")){
            $installer->getConnection()->renameTable($installer->getTable('ids_andreani_sucursal'), $installer->getTable('drubunet_andreani_sucursal'));
        }
        else {
            if(!$installer->tableExists("drubunet_andreani_sucursal")) {
